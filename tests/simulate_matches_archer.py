...
def generate_archer_players(num_players: int):
    """
    Generates a list of players where each player has 10 in Archer,
    and low random values (0.0–5.0) in Cavalry and Infantry.
    ...
    for i in range(num_players):
        ...
        # Force Archer to be 10.
        proficiency["Archer"] = 10.0
        # For Cavalry and Infantry, assign low random values.
        proficiency["Cavalry"] = round(random.uniform(0.0, 5.0), 1)
...
def main():
    ...
    players = generate_archer_players(NUM_PLAYERS)
    all_disparities = []
    all_outcomes = []
